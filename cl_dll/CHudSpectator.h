...
public:
	...
	bool AddOverviewEntityToList( HLHSPRITE sprite, cl_entity_t * ent, double killTime);
...
private:
	...
	HLHSPRITE		m_hsprPlayerBlue;
	HLHSPRITE		m_hsprPlayerRed;
	HLHSPRITE		m_hsprPlayer;
	HLHSPRITE		m_hsprCamera;
	HLHSPRITE		m_hsprPlayerDead;
	HLHSPRITE		m_hsprViewcone;
	HLHSPRITE		m_hsprUnkownMap;
	HLHSPRITE		m_hsprBeam;
	HLHSPRITE		m_hCrosshair;
