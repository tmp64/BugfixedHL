...
public:
	CPlayerListSectionHeader(CPlayerListPanel *parent, const char *name, int sectionID) : Label(parent, name, "")
	{
		m_pListPanel = parent;
	...
	CPlayerListSectionHeader(CPlayerListPanel *parent, const wchar_t *name, int sectionID) : Label(parent, "SectionHeader", "")
	{
		SetText(name);
		SetVisible(false);
		m_pListPanel = parent;
...
public:
	CPlayerListItemButton(CPlayerListPanel *parent, int itemID) : Label(parent, NULL, "< item >")
	{
		m_pListPanel = parent;
		m_iID = itemID;
		m_pData = NULL;
...
// Purpose: Constructor
//-----------------------------------------------------------------------------
CPlayerListPanel::CPlayerListPanel(vgui2::Panel *parent, const char *name) : BaseClass(parent, name)
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CPlayerListPanel::SetItemFgColor(int itemID, SDK_Color color)
{
...
//-----------------------------------------------------------------------------
void CPlayerListPanel::SetSectionFgColor(int sectionID, SDK_Color color)
{
	int index = FindSectionIndexByID(sectionID);
	if (index < 0)
		return;
