...
// hue 0 - 360
// sat and val 0 - 100
void HSVtoRGB(float h, float s, float v, SDK_Color &output);
void RGBtoHSV(SDK_Color rgb, float &hue, float &sat, float &val);
}
...
public:
	...
	void SetColor(SDK_Color color);
	void SetInitialColor(SDK_Color color);
