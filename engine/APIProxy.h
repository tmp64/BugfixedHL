...
typedef HLHSPRITE					(*pfnEngSrc_pfnSPR_Load_t )			( const char *szPicName );
typedef int							(*pfnEngSrc_pfnSPR_Frames_t )			( HLHSPRITE hPic );
typedef int							(*pfnEngSrc_pfnSPR_Height_t )			( HLHSPRITE hPic, int frame );
typedef int							(*pfnEngSrc_pfnSPR_Width_t )			( HLHSPRITE hPic, int frame );
typedef void						(*pfnEngSrc_pfnSPR_Set_t )				( HLHSPRITE hPic, int r, int g, int b );
...
typedef void						(*pfnEngSrc_pfnSetCrosshair_t )		( HLHSPRITE hspr, wrect_t rc, int r, int g, int b );
...
typedef const struct model_s *		(*pfnEngSrc_GetSpritePointer_t )		( HLHSPRITE HLHSPRITE );
...
typedef cmd_function_t*				(*pfnEngSrc_GetNextCmdFunctionHandle_t)(unsigned int cmdhandle);
...
typedef void	(*pfnEngDst_pfnSPR_Frames_t )			( HLHSPRITE * );
typedef void	(*pfnEngDst_pfnSPR_Height_t )			( HLHSPRITE *, int * );
typedef void	(*pfnEngDst_pfnSPR_Width_t )			( HLHSPRITE *, int * );
typedef void	(*pfnEngDst_pfnSPR_Set_t )				( HLHSPRITE *, int *, int *, int * );
...
typedef void	(*pfnEngDst_pfnSetCrosshair_t )			( HLHSPRITE *, struct rect_s *, int *, int *, int * );
...
typedef void	(*pfnEngDst_GetSpritePointer_t )		( HLHSPRITE * );
